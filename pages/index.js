...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <article className='text-left px-4 md:px-0 grid gap-4 grid-cols-1 lg:grid-cols-2 mt-10'>
        ...
        <div className='w-10/12 flex flex-col justify-between'>
          ...
          <div className='w-full flex justify-center md:justify-start'>
            <motion.button
              ...
              whileHover="hover"
              className='px-8 py-4 bg-theme text-theme-yellow font-bold mt-12 flex items-center space-x-3 rounded-3xl'
        ...
        <div className='text-left flex flex-col justify-between'>
          {isLoading
            ...
            : data !== null
              ? (
                <div className='h-full grid content-end relative foodpiccontainer'>
                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">{data[randomMealNumber].title}</h5>
                  <p className="mb-3 font-normal text-gray-700">{data[randomMealNumber].body.slice(0, 150)}</p>
                </div>
              )
              : <p>Not yet</p>
          }
